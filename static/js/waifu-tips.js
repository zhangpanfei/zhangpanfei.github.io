...
loadlive2d('live2d',xb.thome+'/inc/model/api.php?p=22');
...
(function(){
    ...
    var isMobile = $(window).width() <= 530
    $(".waifu").animate({top: isMobile ? $(window).height() * 0.6  : $(window).height()- 250,left: isMobile ? -50 : 0},800);
